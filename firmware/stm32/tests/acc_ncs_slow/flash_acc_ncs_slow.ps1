...
if (-not $BuildDirectory) {
    $BuildDirectory = "D:\study\programming\builds\ESKIN_ACC_NCS_SLOW_ACC$Acc"
}
...
Write-Host "Building slow nCS test for ACC$Acc" -ForegroundColor Cyan
...
Write-Host "Flash complete: SCK=0, ACC$Acc nCS is HIGH for 1 s then LOW for 1 s" -ForegroundColor Green
