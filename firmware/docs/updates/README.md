...
Progress reports are chronological. The newest report is the current summary;
older reports retain the state and conclusions valid on their dates.
...
| 2026-07-31 | [Bring-up update](2026-07-31/PROGRESS_UPDATE.md) | Initial sensor and board bring-up |

> 中文：请优先阅读最新日期的 Update；旧文档用于保留实验过程和历史结论。
